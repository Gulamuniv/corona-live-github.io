...
<html>
<head>
  <title>COVID-19 live Day wise</title>
  ...
  function fetch(){
    ...
    function(data){
     ...
     for (var i = 1; i < data['cases_time_series'].length; i++) {
      ...
      x.insertCell(0);
      tbval.rows[i].cells[0].innerHTML =data['cases_time_series'][i-1]['date'];
      tbval.rows[i].cells[0].style.background ='#7a4a91';
      tbval.rows[i].cells[0].style.color ='#fff';

      x.insertCell(1);
      tbval.rows[i].cells[1].innerHTML =data['cases_time_series'][i-1]['dailyconfirmed'];
      tbval.rows[i].cells[1].style.background ='#4bb7d8';

      x.insertCell(2);
      tbval.rows[i].cells[2].innerHTML =data['cases_time_series'][i-1]['totalconfirmed'];
      tbval.rows[i].cells[2].style.background ='#4bb7d8';


      x.insertCell(3);
      tbval.rows[i].cells[3].innerHTML =data['cases_time_series'][i-1]['totaldeceased'];
      tbval.rows[i].cells[3].style.background ='#4bb7d8';

      x.insertCell(4);
      tbval.rows[i].cells[4].innerHTML =data['cases_time_series'][i-1]['totalrecovered'];
